...
Shared Matplotlib-inspired colormaps and color-ramp utilities for the Zarr Maps packages, based on [jscolormaps](https://github.com/timothygebhard/js-colormaps).
