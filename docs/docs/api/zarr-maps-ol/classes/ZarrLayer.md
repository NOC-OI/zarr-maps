...
| ------ | ------ | ------ |
| `options` | [`OLLayerOptions`](../interfaces/OLLayerOptions.md) | Zarr dataset and OpenLayers tile-layer options. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `array?` | `Layer`\<`Source`, `LayerRenderer`\<`any`\>, \&#123; \[`x`: `string`\]: `any`; \&#125;\>[] | Array of layers (to be modified in place). |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `values` | `Partial`\<`NoInfer`\<`Properties`\>\> | Values. |
| `silent?` | `boolean` | Update without triggering an event. |
