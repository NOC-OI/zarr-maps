...
Queries do not change the slice displayed on the map. See the [`LeafletLayerOptions` API](api/zarr-maps-leaflet/interfaces/LeafletLayerOptions.md) for all configuration options.
